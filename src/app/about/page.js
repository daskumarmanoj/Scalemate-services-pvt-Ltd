...
import { X, Target, TrendingUp, Award, MapPin, Lightbulb, BarChart2, Handshake, Star, Users, Calendar, Globe, Briefcase } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] rounded-full bg-yellow-500/5 blur-[120px]" />
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 pt-24 pb-24"
      >
        {/* ── Hero Section ── */}
        ...
        <motion.div variants={itemVariants} className="mb-24">
          <div className="mb-10">
            ...
            <p className="text-gray-500">The principles that drive every decision we make for our clients.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
            {values.map((v, i) => (
              <motion.div
                ...
                hover:border-yellow-500/30 hover:bg-yellow-500/[0.04] transition-colors duration-300"
              >
                <div className="w-10 h-10 rounded-xl bg-yellow-500/10 text-yellow-400 
        ...
        <motion.div variants={itemVariants} className="mb-24">
          <div className="grid md:grid-cols-2 gap-6">
            {/* Mission */}
            <div className="relative rounded-2xl border border-yellow-500/20 bg-gradient-to-br from-yellow-500/6 to-transparent p-8 overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 rounded-full bg-yellow-500/5 blur-2xl pointer-events-none" />
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-xl bg-yellow-500/15 flex items-center justify-center shrink-0">
                  <Target className="text-yellow-400" size={20} />
                </div>
                <div>
                  <p className="text-yellow-400 text-xs font-semibold tracking-widest uppercase">Our</p>
                  <h3 className="text-white text-2xl font-bold leading-tight">Mission</h3>
                </div>
              </div>
              <p className="text-gray-400 text-base leading-relaxed">
                To empower businesses with{" "}
                <span className="text-white font-medium">strategic clarity, data-driven insights,</span> and{" "}
                <span className="text-white font-medium">execution excellence</span>. At Scalemate, our mission is to enable
                startups and enterprises to build strong foundations, access the right funding opportunities, and achieve{" "}
                <span className="text-yellow-400 font-medium">sustainable, scalable growth</span> through structured
                guidance and measurable outcomes.
              </p>
            </div>

            {/* Vision */}
            <div className="relative rounded-2xl border border-white/[0.08] bg-white/[0.02] p-8 overflow-hidden hover:border-yellow-500/20 transition-colors duration-300">
              <div className="absolute bottom-0 left-0 w-32 h-32 rounded-full bg-yellow-500/4 blur-2xl pointer-events-none" />
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <p className="text-yellow-400 text-xs font-semibold tracking-widest uppercase">Our</p>
                  <h3 className="text-white text-2xl font-bold leading-tight">Vision</h3>
                </div>
              </div>
              <p className="text-gray-400 text-base leading-relaxed">
                To become a{" "}
                <span className="text-white font-medium">trusted global growth partner</span> for businesses, recognized
                for transforming ideas into scalable success stories. We envision Scalemate as a leader in{" "}
                <span className="text-yellow-400 font-medium">business consulting and funding advisory</span>, driving
                innovation, creating impact, and shaping the future of entrepreneurship.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mb-24">
          <div className="mb-10 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-yellow-500/30 
              bg-yellow-500/5 text-yellow-400 text-xs font-semibold tracking-widest uppercase mb-4">
              <TrendingUp size={12} />
              Funding Access
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">
              Unlock the Right Capital
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              We help you identify and apply for the funding that fits your stage and vision.
            </p>
          </div>
            ...
            {[
              {
                ...
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7" stroke="currentColor" strokeWidth={1.8}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 6l9-3 9 3v6c0 5.25-4 9.75-9 11C7 21.75 3 17.25 3 12V6z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l2 2" />
                  </svg>
                ),
                desc: "Government grants for eligible startups and enterprises.",
              },
              {
                amount: "Upto ₹20 Cr",
                label: "CGSS Fund",
              ...
              },
              {
                ...
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7" stroke="currentColor" strokeWidth={1.8}>
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2 10h20M7 15h.01M11 15h4" />
                  </svg>
                ),
                desc: "Prime Minister's Employment Generation Programme subsidy.",
              },
            ].map((fund, i) => (
              <motion.div
                key={i}
                ...
                border border-white/[0.08] bg-white/[0.02] hover:border-yellow-500/30 
                hover:bg-yellow-500/[0.03] transition-colors duration-300 group"
              >
                <div className="w-16 h-16 rounded-full bg-yellow-500/10 border border-yellow-500/20 
                  text-yellow-400 flex items-center justify-center mb-6 
                  group-hover:bg-yellow-500/15 transition-colors duration-300">
                  {fund.icon}
                </div>
                <span className="text-4xl font-black text-white tracking-tight mb-1">
                  {fund.amount}
                </span>
                <span className="text-gray-400 text-sm font-medium mb-4">{fund.label}</span>
                <p className="text-gray-600 text-xs leading-relaxed mb-6">{fund.desc}</p>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.96 }}
                  onClick={() => setIsOpen(true)}
                  className="px-6 py-2.5 rounded-full bg-yellow-500 text-black text-sm font-bold 
                  shadow-lg shadow-yellow-500/20 tracking-wide"
                >
                  → Apply Now
                </motion.button>
              </motion.div>
        ...
        <motion.div variants={itemVariants} className="mb-24">
          <div className="mb-10 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Our Business Partners</h2>
            <p className="text-gray-600 text-sm">Trusted names we work alongside to deliver the best for our clients.</p>
          </div>
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.015] px-8 py-10">
            <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-8">
              ...
              <div className="flex items-center gap-2 opacity-60 hover:opacity-100 transition-opacity duration-300">
                <div className="w-6 h-6 rounded bg-[#528FF0] flex items-center justify-center">
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white">
                    <path d="M14.5 2L5 13h7l-2.5 9L19 11h-7z" />
                  </svg>
                </div>
              ...
              <div className="opacity-60 hover:opacity-100 transition-opacity duration-300">
                <div className="flex items-center gap-1.5">
                  <div className="w-5 h-5 bg-[#004C8F] rounded-sm flex items-center justify-center">
                    <span className="text-white text-[8px] font-black">H</span>
                  </div>
                  <div>
                    <div className="text-[#004C8F] font-black text-sm leading-none">HDFC BANK</div>
                    <div className="text-gray-500 text-[9px] leading-none">We understand your world</div>
                  </div>
                </div>
              </div>
              ...
              <div className="opacity-60 hover:opacity-100 transition-opacity duration-300">
                <div className="flex items-center gap-1.5">
                  ...
                  <div>
                    <span className="text-white font-bold text-sm">Cashfree</span>
                    <span className="text-gray-400 font-normal text-sm"> Payments</span>
                  </div>
                </div>
              </div>

              {/* Airtel */}
              <div className="opacity-60 hover:opacity-100 transition-opacity duration-300 flex items-center gap-1.5">
                <div className="w-6 h-6 rounded-full bg-red-600 flex items-center justify-center">
                  <div className="w-3 h-3 rounded-full border-2 border-white" />
                </div>
                <span className="text-white font-semibold text-lg">airtel</span>
              </div>

              {/* Tata Tele */}
              <div className="opacity-60 hover:opacity-100 transition-opacity duration-300 flex items-center gap-2">
                <div className="flex flex-col leading-none">
                  <span className="text-white font-black text-sm tracking-wide">TATA</span>
                  <span className="text-gray-400 text-[10px] font-medium">Tele Business Services</span>
                </div>
                <div className="w-7 h-5 rounded bg-orange-500 flex items-center justify-center">
                  <span className="text-white text-[9px] font-black">BIG</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <motion.div
          variants={itemVariants}
          className="rounded-2xl border border-yellow-500/20 bg-gradient-to-r from-yellow-500/8 to-yellow-600/4 
          p-10 flex flex-col md:flex-row items-center justify-between gap-6"
        >
          <div>
            <h3 className="text-white text-2xl font-bold mb-1">Ready to scale with us?</h3>
            <p className="text-gray-400 text-sm">Book a free 30-minute strategy call. No pitch, no fluff.</p>
          </div>
          <motion.button
            whileHover={{ scale: 1.04 }}
            whileTap={{ scale: 0.97 }}
            onClick={() => setIsOpen(true)}
            className="px-8 py-3 rounded-full bg-yellow-500 text-black font-bold 
            text-sm tracking-wide shadow-lg shadow-yellow-500/20 whitespace-nowrap shrink-0"
          >
            Book Consultation →
          </motion.button>
        </motion.div>
